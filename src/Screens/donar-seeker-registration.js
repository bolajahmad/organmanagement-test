...
export class DRegister extends React.Component {
  ...
  async onSubmit(event) {
    ...
    axios
      .post("http://localhost:4000/ur/", registration) /// After Hosting change to hosted backend name
      .then((res) => {
        console.log(res);
        if (!res.data.message) {
          var link = "/login";
      ...
      <div class="limiter">
        <div class="container-login100 background-image">
          <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
            ...
            >
              <span class="login100-form-title p-b-49">User Registeration</span>
              ...
              <div
                class="wrap-input100 validate-input m-b-23"
                data-validate="metamask id is reauired"
              >
                ...
                <input
                  ...
                  type="text"
                  name="metamaskid"
                  placeholder="Type your Meta Mask ID"
                  autoComplete="off"
                  required
                  onChange={this.changemetamaskid}
                  value={this.state.metamaskid}
                />
                <span class="focus-input100" data-symbol="&#xf206;"></span>
              </div>
              ...
              <div
                class="wrap-input100 validate-input form-group has-feedback cp"
                id="message1"
                data-validate="Password is required"
              >
              ...
              <div
                class="container-login100-form-btn hidden"
                id="disabled"
                style={{ marginTop: "10%" }}
              >
